...
for sentence in data:
    ...
    tokens = [word for word in tags if (word.pos_ == 'NOUN')]
...
# x = {'Wii', 'User', 'game', 'xbox', 'Sony', 'PS4', 'understand', 'gba', 'Luka_P', 'playstation', 'week', 'console', 'Info', 'audience', 'whats', 'U', 'gaming', 'consumer', 'appreciate', 'playstation3', 'playstation.com'}


# ss = en.synsets('Sony', pos='n')[0]
# print(ss.definition())